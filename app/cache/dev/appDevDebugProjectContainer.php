...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.customer_service' => 'getApp_CustomerServiceService',
            'app.group_service' => 'getApp_GroupServiceService',
            'app.order_service' => 'getApp_OrderServiceService',
            'app.user_group_service' => 'getApp_UserGroupServiceService',
            'app.user_profile_service' => 'getApp_UserProfileServiceService',
    ...
    /**
     * Gets the 'app.customer_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CustomerService A AppBundle\Service\CustomerService instance.
     */
    protected function getApp_CustomerServiceService()
    {
        return $this->services['app.customer_service'] = new \AppBundle\Service\CustomerService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.group_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\GroupService A AppBundle\Service\GroupService instance.
     */
    protected function getApp_GroupServiceService()
    {
        return $this->services['app.group_service'] = new \AppBundle\Service\GroupService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.order_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\OrderService A AppBundle\Service\OrderService instance.
     */
    protected function getApp_OrderServiceService()
    {
        return $this->services['app.order_service'] = new \AppBundle\Service\OrderService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.user_group_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UserGroupService A AppBundle\Service\UserGroupService instance.
     */
    protected function getApp_UserGroupServiceService()
    {
        return $this->services['app.user_group_service'] = new \AppBundle\Service\UserGroupService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.user_profile_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UserProfileService A AppBundle\Service\UserProfileService instance.
     */
    protected function getApp_UserProfileServiceService()
    {
        return $this->services['app.user_profile_service'] = new \AppBundle\Service\UserProfileService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['app.user_service'] = new \AppBundle\Service\UserService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'orm', 'user' => 'root', 'password' => 'Guobin83', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0118273c5e8d3b399e8634702019bde750012855b33c1ca012bb260fb78756a0');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '0ab5b29165124fca4695186ea6fe59f3c69ef933');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0ab5b29165124fca4695186ea6fe59f3c69ef933');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57874b44d3378')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'orm',
            'database_user' => 'root',
            'database_password' => 'Guobin83',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '0ab5b29165124fca4695186ea6fe59f3c69ef933',
            ...
            'kernel.secret' => '0ab5b29165124fca4695186ea6fe59f3c69ef933',
